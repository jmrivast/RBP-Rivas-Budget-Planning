              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: _fieldWidth(maxWidth, 160),
                      child: TextField(
                    ...
                    SizedBox(
                      width: _fieldWidth(maxWidth, 150),
                      child: TextField(
                    ...
                    SizedBox(
                      width: _fieldWidth(maxWidth, 140, minWidth: 140),
                      child: TextField(
                    ...
                    SizedBox(
                      width: _fieldWidth(maxWidth, 120, minWidth: 120),
                      child: TextField(
...
Future<void> _showDebtPaymentsDialog(BuildContext context, Debt debt) async {
  await showDialog<void>(
    ...
    builder: (context) {
      ...
      final dialogWidth = math.min(screen.width - 32, 920.0);
      final dialogHeight = math.min(screen.height * 0.78, 520.0);
      return AlertDialog(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Wrap(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: math.min(dialogWidth * 0.35, 280),
                        child: Text(
                          p.notes?.trim().isNotEmpty == true ? p.notes! : '-',
                          overflow: TextOverflow.ellipsis,
                        ),
                      ),
                      Text('Int: ${formatCurrency(p.interestAmount)}'),
