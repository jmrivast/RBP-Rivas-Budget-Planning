      ...
      builder: (context, finance, _) {
        ...
        return LayoutBuilder(
          builder: (context, viewport) {
                ...
                child: Column(
                  ...
                  children: [
                    const Text('Ahorro total',
                        style: TextStyle(fontWeight: FontWeight.w600)),
                    const SizedBox(height: 4),
                    Text('Disponible: ${formatCurrency(totalSavings)}',
                        style: TextStyle(color: AppColors.subtitle)),
                    const SizedBox(height: 8),
                    Wrap(
                      spacing: 10,
                      ...
                      children: [
                        ...
                        FilledButton.icon(
                          onPressed: () async {
                            final amount =
                                double.tryParse(_withdrawCtrl.text.trim());
                            if (amount == null || amount <= 0) {
                              _show('Ingresa monto valido.');
                              return;
                            }
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            keyboardType: const TextInputType.numberWithOptions(
                                decimal: true),
                            decoration: const InputDecoration(
                              labelText: 'Aporte extra al ahorro total RD\$',
                              hintText: '1200',
                            ),
                          ),
                        ),
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'Este aporte suma al ahorro total y no descuenta del salario del periodo.',
                      style: TextStyle(
                        fontSize: 12,
            ...
            final guidedTopCards = widget.guideKey == null
                ? topCards
                : GuidedShowcase(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Padding(
                                  ...
                                  child: SavingsGoalItem(
                                    ...
                                    onEdit: () => showEditGoalDialog(context,
