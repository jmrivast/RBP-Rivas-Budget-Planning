...
Notas:
- Version estable actual: `2.0.2`.
- Si Windows muestra advertencia de seguridad, valida que el archivo sea `RBP_Setup_2.0.2.exe`.
...
3. Genera instalador:
   - `powershell -ExecutionPolicy Bypass -File installer/build_nsis.ps1 -Version 2.0.2`
4. Resultado:
   - `dist/RBP_Setup_2.0.2.exe`
...
- Cambios de esta version: ver `RELEASE_NOTES_2.0.2.md`.
